...
import me.rekii.tacocloud.data.TacoRepository;
...
public class DevelopmentConfig {
    ...
    @Bean
    public CommandLineRunner dataLoader(IngredientRepository repo, PasswordEncoder passwordEncoder,
        ...
        return args -> {
            ...
            repo.save(salsa);
            repo.save(sourCream);
            User user = new User("togashi", passwordEncoder.encode("togashi"),
